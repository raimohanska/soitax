...
const lit=()=>d.body.classList.contains('pulse')||d.body.classList.contains('pulse-accent');
const accent=()=>d.body.classList.contains('pulse-accent');
...
(async()=>{
  ...
  ok(w.__hats.length===0,'no metronome clicks in silent mode');
